...
export default function Home() {
  ...
  const classify = async () => {
    ...
    try {
      const result = await fetch(`/api/classify?text=${encodeURIComponent(tweet.text)}`);
    ...
    <main className="min-h-screen bg-gradient-to-br from-gray-900 to-gray-800 text-white p-8">
      <div className="max-w-4xl mx-auto">
        ...
        <Card className="bg-gray-800 border-gray-700 mb-8">
          <CardHeader>
            <CardTitle className="text-2xl font-semibold text-white">Enter Tweet ID</CardTitle>
          </CardHeader>
          <CardContent>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <Card className="bg-gray-800 border-gray-700">
            <CardHeader>
              <CardTitle className="text-2xl font-semibold text-white">Tweet Preview</CardTitle>
            </CardHeader>
